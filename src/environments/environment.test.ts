...
const { domain, clientId, audience, apiUri, errorPath, } = config.testing as {
  domain: string;
  clientId: string;
  audience?: string;
  apiUri: string;
...
export const environment = {
  ...
  ump_endpoint_url: 'https://hubtest.bdpsmart.com/portal-api/',

  smartHubUrl: "https://hubtest.bdpsmart.com/#",
